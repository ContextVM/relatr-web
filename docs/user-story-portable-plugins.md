...
- Relatr still owns normalization rules (sorting, bounds, verification flag), as described in the runtime-focused guidance in [`./elo-plugin-writers-guide.md`](./elo-plugin-writers-guide.md).
